...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="CAPTURE" URI="http://resources/4.0.4/app/CAPTURE/1" description="Perform signal analysis to find out the duty cycle and the period of an unknown input signal." mode="NOTSHARABLE" version="4.0.4" minDaveVersion="4.2.4" instanceLabel="CAPTURE_R" appLabel="" containingProxySignal="true">
  ...
  <hwResources name="Capture Input Pin" URI="http://resources/4.0.4/app/CAPTURE/1/__pin_hwres_port_pad_capture_in" resourceGroupUri="devicepackage/0/43" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">

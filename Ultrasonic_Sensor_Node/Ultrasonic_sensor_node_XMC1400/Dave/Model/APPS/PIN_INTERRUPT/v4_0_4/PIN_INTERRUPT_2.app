...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="PIN_INTERRUPT" URI="http://resources/4.0.4/app/PIN_INTERRUPT/2" description="The PIN_INTERRUPT APP invokes user interrupt handler in a response &#xA;to rising and/or falling edge event signal on a pin." mode="NOTSHARABLE" version="4.0.4" minDaveVersion="4.0.0" instanceLabel="ECHO_C" appLabel="">
  ...
  <virtualSignals name="iout" URI="http://resources/4.0.4/app/PIN_INTERRUPT/2/vs_pin_interrupt_iout" hwSignal="iout" hwResource="//@hwResources.3"/>
  <virtualSignals name="sr_node" URI="http://resources/4.0.4/app/PIN_INTERRUPT/2/vs_pin_interrupt_signal" hwSignal="signal_in" hwResource="//@hwResources.0"/>
  <virtualSignals name="Pin_signal" URI="http://resources/4.0.4/app/PIN_INTERRUPT/2/__pin_vs_pin_interrupt_iopad" hwSignal="pin" hwResource="//@hwResources.4"/>
  <requiredApps URI="http://resources/4.0.4/app/PIN_INTERRUPT/2/appres_cpu" requiredAppName="CPU_CTRL_XMC1" requiringMode="SHARABLE">
    <downwardMapList xsi:type="ResourceModel:App" href="../../CPU_CTRL_XMC1/v4_0_12/CPU_CTRL_XMC1_0.app#/"/>
  </requiredApps>
  <hwResources name="External Event" URI="http://resources/4.0.4/app/PIN_INTERRUPT/2/hwres_interrupt" resourceGroupUri="peripheral/cpu/0/nvic/interrupt/*" mResGrpUri="peripheral/cpu/0/nvic/interrupt/*">
  ...
  <hwResources name="Pin" URI="http://resources/4.0.4/app/PIN_INTERRUPT/2/__pin_hwres_port_pin" resourceGroupUri="devicepackage/0/10" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
  ...
  <connections URI="http://resources/4.0.4/app/PIN_INTERRUPT/2/http://resources/4.0.4/app/PIN_INTERRUPT/2/vs_pin_interrupt_iout/http://resources/4.0.4/app/PIN_INTERRUPT/2/vs_pin_interrupt_signal" systemDefined="true" sourceSignal="iout" targetSignal="sr_node" srcVirtualSignal="//@virtualSignals.4" targetVirtualSignal="//@virtualSignals.5"/>
  <connections URI="http://resources/4.0.4/app/PIN_INTERRUPT/2/http://resources/4.0.4/app/PIN_INTERRUPT/2/vs_pin_interrupt_iopad/http://resources/4.0.4/app/PIN_INTERRUPT/2/__pin_vs_pin_interrupt_iopad" systemDefined="true" sourceSignal="external_event_pin" targetSignal="Pin_signal" srcVirtualSignal="//@virtualSignals.1" targetVirtualSignal="//@virtualSignals.6"/>
  <connections URI="http://resources/4.0.4/app/PIN_INTERRUPT/2/http://resources/4.0.4/app/PIN_INTERRUPT/2/__pin_vs_pin_interrupt_iopad/http://resources/4.0.4/app/PIN_INTERRUPT/2/vs_pin_interrupt_iopad" systemDefined="true" sourceSignal="Pin_signal" targetSignal="external_event_pin" srcVirtualSignal="//@virtualSignals.6" targetVirtualSignal="//@virtualSignals.1"/>
</ResourceModel:App>
